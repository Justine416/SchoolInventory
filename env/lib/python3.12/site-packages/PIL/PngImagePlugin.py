...
# 1998-07-12 fl   Read/write 16-bit item_images as mode I (0.4)
...
# 2008-08-13 fl   Added tRNS support for RGB item_images
...
##
# Image plugin for PNG item_images.
    ...
    def seek(self, frame: int) -> None:
        ...
        for f in range(self.__frame + 1, frame + 1):
            try:
                ...
                msg = "no more item_images in APNG file"
...
def _save(
    ...
    if mode == "P":
        #
        # attempt to minimize storage requirements for palette item_images
