...
# 1998-06-28 fl   Handle I and F item_images
...
"""
A simple 2D drawing interface for PIL item_images.
<p>
...
class ImageDraw:
    ...
    def __init__(self, im: Image.Image, mode: str | None = None) -> None:
        ...
        :param mode: Optional mode to use for color values.  For RGB
           item_images, this argument can be RGB or RGBA (to blend the
        ...
        if mode in ("I", "F"):
            ...
            self.ink = self.draw.draw_ink(-1)
        if mode in ("1", "P", "I", "F"):
            # FIXME: fix Fill2 to properly support matte for I+F item_images
            self.fontmode = "1"
        else:
