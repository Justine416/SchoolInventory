...
# 2004-02-21 fl   Fixes for 1/L/CMYK item_images, etc.
# 2004-02-24 fl   Fixes for 1 and P item_images.
#
...
##
# Image plugin for PDF item_images (output only).
##
...
def _write_image(
    ...
    if im.mode == "1":
        ...
        procset = "ImageC"  # color item_images
    elif im.mode == "RGBA":
        decode_filter = "JPXDecode"
        procset = "ImageC"  # color item_images
        dict_obj["SMaskInData"] = 1
