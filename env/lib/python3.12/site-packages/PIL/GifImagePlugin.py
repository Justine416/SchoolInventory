...
# 2004-02-24 fl   Disable interlacing for small item_images
#
...
##
# Image plugin for GIF item_images.  This plugin supports both GIF87 and
# GIF89 item_images.
    ...
    def seek(self, frame: int) -> None:
        ...
        for f in range(self.__frame + 1, frame + 1):
            try:
                ...
                msg = "no more item_images in GIF file"
...
def _normalize_palette(
    ...
    Normalizes the palette for image.
      ...
      - Ensures that there's a palette for L mode item_images
