...
OPEN_INFO = {
    ...
    (II, 6, (1,), 1, (8,), ()): ("L", "L"),
    (MM, 6, (1,), 1, (8,), ()): ("L", "L"),
    # JPEG compressed item_images handled by LibTiff and auto-converted to RGBX
    # Minimal Baseline TIFF requires YCbCr item_images to have 3 SamplesPerPixel
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _seek(self, frame: int) -> None:
        ...
        while len(self._frame_pos) <= frame:
            if not self.__next:
                msg = "no more item_images in TIFF file"
                raise EOFError(msg)
            logger.debug(
    ...
    def _setup(self) -> None:
        ...
        # old style jpeg compression item_images most certainly are YCbCr
        ...
        if self.use_load_libtiff:
            ...
            # so large g4 item_images will fail if we use that
            # function.
            #
            ...
            if fillorder == 2:
                ...
                # fillorder=1 mode
                self._mode, rawmode = OPEN_INFO[key]
            # YCbCr item_images with new jpeg compression with pixels in one plane
...
def _save(im: Image.Image, fp: IO[bytes], filename: str | bytes) -> None:
    ...
    # required for color libtiff item_images
