...
LIBTIFF_CORE.remove(322)  # We don't have support for writing tiled item_images with libtiff
LIBTIFF_CORE.remove(323)  # Tiled item_images
LIBTIFF_CORE.remove(333)  # Ink Names either

# Note to advanced users: There may be combinations of these
# parameters and values that when added properly, will work and
# produce valid tiff item_images that may work in your application.
